                        ...
                        <MuiThemeProvider muiTheme={getMuiTheme()}>
                            <form onSubmit={handleSubmit(this.onSubmit.bind(this))}>
                                <div className="form-group">
                                    <Field type="text" name="productName" component={renderTextField} label="Product Name" />
                                </div>
                                <div>
                                    <Field type="number" name="unitPrice" component={renderTextField} label="Price" />
                                </div>
                                <div>
                                    <Field type="number" name="unitsInStock" component={renderTextField} label="Stock Quantity" />
                                </div>
                                <div>
