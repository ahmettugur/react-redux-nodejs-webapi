...
class ProductList extends Component {
    ...
    renderProducts() {
        return this.props.productList.map((product) => {
            return (
                <div key={product._id} className="col-sm-3 col-md-3 product-list">
                        ...
                        <div className="caption">
                            ...
                            <div>
                                <span className="pull-left">
                                    <strong>
                                        {this.currencyFormat(product.unitPrice)}
                                    </strong>
                                </span>
                                <Link to={"/web/productdetail/"+product._id} className="btn btn-xs btn-success pull-right">Go to Detail</Link>
                            </div>
                        </div>
                    </div>
                </div>
