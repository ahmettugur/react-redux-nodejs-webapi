        ...
        return this.props.categories.map((category) => {
            return (
                <tr key={category._id}>
                    ...
                    <td>
                        <a className="btn btn-sm btn-danger pull-right" title="Delete" onClick={() => this.deletecategory(category._id)} >
                            <i className="glyphicon glyphicon-trash"></i>
                        </a>
                        <Link className="btn btn-sm btn-warning pull-right button-margin" title="Edit" to={"/admin/category/categoryform/" + category._id} >
